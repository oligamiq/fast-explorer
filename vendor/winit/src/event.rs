...
pub enum Ime {
    ...
    /// Full text-input buffer state supplied by Android GameTextInput.
    ///
    /// This preserves surrounding text, selection, and composing region so editors can
    /// keep Android IMEs synchronized without lossy string-diff heuristics.
    BufferState {
        text: String,
